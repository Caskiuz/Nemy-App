    ...
    return (
      <ThemedView style={[styles.container, { paddingTop: insets.top }]}>
        ...
        <ScrollView contentContainerStyle={styles.content}>
          {/* Monto a pagar */}
          <View style={[styles.amountCard, { backgroundColor: NemyColors.error }, Shadows.lg]}>
          ...
          <View style={[styles.proofCard, { backgroundColor: theme.card }, Shadows.md]}>
            ...
            <Pressable
              ...
              style={[styles.submitButton, { backgroundColor: NemyColors.success, opacity: submitMutation.isPending ? 0.5 : 1 }]}
            >
    ...
    <ThemedView style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        {settlement.status === "pending" && hoursLeft < 24 && (
          <View style={[styles.alertCard, { backgroundColor: NemyColors.error + "20" }]}>
            <Feather name="alert-circle" size={24} color={NemyColors.error} />
            <View style={{ flex: 1, marginLeft: Spacing.md }}>
              <ThemedText type="body" style={{ color: NemyColors.error, fontWeight: "600" }}>
                ¡Tiempo límite!
              </ThemedText>
              <ThemedText type="small" style={{ color: NemyColors.error }}>
        ...
        {/* Monto a pagar */}
        <View style={[styles.amountCard, { backgroundColor: NemyColors.primary }, Shadows.lg]}>
          <ThemedText type="caption" style={{ color: "#FFF", opacity: 0.8 }}>
            Debes depositar
          </ThemedText>
          <ThemedText type="h1" style={{ color: "#FFF", fontSize: 48, marginVertical: Spacing.sm }}>
        ...
        {settlement.status === "submitted" && (
          <View style={[styles.statusCard, { backgroundColor: NemyColors.warning + "20" }]}>
            <Feather name="clock" size={32} color={NemyColors.warning} />
            <ThemedText type="h4" style={{ color: NemyColors.warning, marginTop: Spacing.md }}>
