      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style={[styles.card, { backgroundColor: theme.card }, Shadows.md]}>
          ...
          <Pressable
            ...
            style={[styles.saveButton, { backgroundColor: NemyColors.primary, opacity: saveMutation.isPending ? 0.5 : 1 }]}
          >
        ...
        {data?.bankAccount && (
          <View style={[styles.previewCard, { backgroundColor: NemyColors.success + "20" }]}>
            <Feather name="check-circle" size={24} color={NemyColors.success} />
