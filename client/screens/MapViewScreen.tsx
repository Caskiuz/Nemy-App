    ...
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      <View style={[styles.header, { backgroundColor: theme.card, borderBottomColor: theme.border }]}>
        ...
        <View style={styles.headerActions}>
          ...
          >
            <Feather name={soundEnabled ? "volume-2" : "volume-x"} size={20} color={soundEnabled ? NemyColors.primary : theme.textSecondary} />
          </TouchableOpacity>
          <TouchableOpacity 
            onPress={() => {
            ...
            style={styles.headerButton}
          >
            <Feather name={notificationsEnabled ? "bell" : "bell-off"} size={20} color={notificationsEnabled ? NemyColors.primary : theme.textSecondary} />
          </TouchableOpacity>
          <TouchableOpacity 
            onPress={() => {
        ...
        {businesses
          ...
          .map((business) => (
            <Marker
              ...
              pinColor={business.isActive ? NemyColors.success : NemyColors.error}
            >
              <View style={[styles.businessMarker, { backgroundColor: business.isActive ? NemyColors.success : NemyColors.error }]}>
      ...
      {showOrdersList && (
        <View style={[styles.ordersPanel, { backgroundColor: theme.card }]}>
          <View style={styles.ordersPanelHeader}>
            ...
            <View style={[styles.liveIndicator, { backgroundColor: NemyColors.error }]}>
            ...
            {STATUS_FILTERS.map((filter) => (
              <TouchableOpacity
                ...
                style={[
                  styles.filterButton,
                  {
                    backgroundColor: statusFilter === filter.key ? NemyColors.primary : theme.backgroundSecondary,
                    borderColor: statusFilter === filter.key ? NemyColors.primary : theme.border,
                  },
                ]}
                onPress={() => {
