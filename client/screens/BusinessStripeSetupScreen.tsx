...
export default function BusinessStripeSetupScreen() {
  ...
  const getStatusColor = () => {
    ...
    if (stripeStatus.chargesEnabled && stripeStatus.payoutsEnabled) return NemyColors.success;
    if (stripeStatus.detailsSubmitted) return NemyColors.warning;
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.backgroundDefault }]}>
      ...
      >
            ...
            <View style={styles.statusDetails}>
              <View style={styles.statusRow}>
                <Feather
                  ...
                  size={18}
                  color={stripeStatus.chargesEnabled ? NemyColors.success : NemyColors.error}
                />
              ...
              <View style={styles.statusRow}>
                <Feather
                  ...
                  size={18}
                  color={stripeStatus.payoutsEnabled ? NemyColors.success : NemyColors.error}
                />
                <ThemedText type="body" style={{ marginLeft: Spacing.sm }}>
        ...
        {!stripeStatus.connected ? (
          <>
            <View style={[styles.infoCard, { backgroundColor: NemyColors.primary + '15' }]}>
            ...
            <Pressable
              style={[styles.primaryButton, { backgroundColor: NemyColors.primary }, Shadows.md]}
            ...
            <View style={[styles.requirementsCard, { backgroundColor: theme.card }, Shadows.sm]}>
              ...
              <View style={styles.requirementRow}>
                <Feather name="check" size={18} color={NemyColors.success} />
                <ThemedText type="body" style={{ marginLeft: Spacing.sm }}>
          ...
          <>
            ...
            >
              <Feather name="external-link" size={20} color={NemyColors.primary} />
              <ThemedText type="body" style={{ color: NemyColors.primary, fontWeight: '600', marginLeft: Spacing.sm }}>
                Abrir Dashboard de Stripe
              </ThemedText>
            </Pressable>

            <Pressable
              style={[styles.dangerButton, { backgroundColor: theme.card, borderColor: NemyColors.error }]}
              onPress={handleDisconnectStripe}
            >
              <Feather name="x-circle" size={20} color={NemyColors.error} />
              <ThemedText type="body" style={{ color: NemyColors.error, fontWeight: '600', marginLeft: Spacing.sm }}>
                Desconectar Cuenta
              </ThemedText>
            </Pressable>
          </>
        ...
        <View style={[styles.helpCard, { backgroundColor: theme.backgroundSecondary }]}>
          ...
          <View style={{ flex: 1, marginLeft: Spacing.md }}>
            <ThemedText type="small" style={{ color: theme.textSecondary }}>
              Tus ingresos se procesan directamente a través de Stripe Connect. Recibes el 100% del precio base de tus productos. NEMY agrega un 15% de markup al precio final del cliente.
            </ThemedText>
          </View>
        </View>
      </ScrollView>
